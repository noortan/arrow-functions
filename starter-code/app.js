...
let joe = new Student('noortan', 'jordan', 32);
...
// 1. What is "this" when joe.scope() is invoked?
 // this is referred to the object that create from student constructor which name "jon"

// 2. What is "this" when joe.scopeArrow() is invoked?
// this in arrow function or scopeArrow referred to window


// 3. Explain why "this" is different when an arrow function is used.
//in ES6, arrow functions use lexical scoping — ‘this' refers to it's current surrounding scope and no further. Thus the inner function knew to bind to the inner function only,
