...
const newObject = array => ({
 ...
 // let message = function(name) {
  ...
  const oneLiner = message => `Hello , ${name}`;
...
Student.prototype.scope = function() {
  ...
  //In fact I did not fully understand the idea, and this caused me weakness in writing the code using the arrow function 
  //
  // 2. What is "this" when joe.scopeArrow() is invoked?

  
  //I'm sorry, I encountered many problems, I could not work exactly as required
